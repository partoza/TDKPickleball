...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm outline-none focus:bg-primary/10 focus:text-primary data-[state=checked]:text-primary data-[state=checked]:font-semibold data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50 transition-colors",
      className
    )}
    {...props}
  >
