...
public interface IAuthService
{
    ...
    Task<ApiResponse<AuthResponse>> GoogleLoginAsync(string providerKey, string email, string firstName, string lastName, string? profileImageUrl);
    ...
    Task<ApiResponse<bool>> VerifyAdminCredentialsAsync(string userId, string email, string password);
