...
public record BookingDto(long Id, string BookingReference, int CourtId, string CourtName, string CustomerName, string Email, string? Phone, DateOnly BookingDate, TimeOnly StartTime, TimeOnly EndTime, decimal Subtotal, decimal DiscountAmount, decimal TotalAmount, decimal AmountPaid, decimal RemainingBalance, BookingStatus Status, string? Notes, DateTime CreatedAt, RateType BookingType = RateType.Booking, bool ReceiptAvailable = false, DateTime? RescheduledAt = null, int? StaffProfileId = null, int? PromoId = null);
public record CreateBookingRequest(int CourtId, DateOnly BookingDate, TimeOnly StartTime, TimeOnly EndTime, string CustomerName, string? Email, string? Phone, string? Notes, decimal AmountPaid = 0, RateType RateType = RateType.Booking, int? StaffProfileId = null, int? PromoId = null);
public record UpdateBookingRequest(int CourtId, DateOnly BookingDate, TimeOnly StartTime, TimeOnly EndTime, string CustomerName, string? Email, string? Phone, string? Notes, decimal AmountPaid, BookingStatus Status, int? StaffProfileId = null, int? PromoId = null);
